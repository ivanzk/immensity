  ...
  function(e, n, t) {
    ...
    var r = function(e) {
        ...
        return (
          e &&
            e.getAttributeNames().forEach(function(r) {
              n.includes(r) ||
                (t.push({ name: r, value: e.getAttribute(r) }),
                e.removeAttribute(r));
            }),
          t
        );
      ...
      o = function() {
        ...
        if ((e && r(u), n)) {
          ...
          r(a), (a.innerHTML = ''), (document.title = l);
        }
        t && (r(i), (i.innerHTML = ''));
      },
      a = function(e) {
        var n = { hr: 3600, min: 60, sec: 1 },
          t = [];
        for (var r in n)
          if (e >= n[r]) {
            var o = parseInt(e / n[r]);
            (e -= o * n[r]), t.push(o);
          } else t.push(0);
        return t;
      },
    ...
    var l = function() {
        ...
        return (
          ...
          'prepend' === e.type ? e.parent.prepend(t) : e.parent.append(t),
          e.child && t.append(e.child),
          t
        );
      },
      c = function() {
    ...
    var s = function(e) {
        var n =
          ...
          l = t.download;
        r = ((r && r + o) || Date.now()) + i;
        var s = c('canvas', { width: e.videoWidth, height: e.videoHeight });
        s.getContext('2d').drawImage(e, 0, 0, s.width, s.height),
          s.toBlob(
            function(e) {
              return (
                l &&
                  c('a', { href: URL.createObjectURL(e), download: r }).click(),
                e
              );
            },
            a,
      ...
      f = function(e, n) {
        return e.preventDefault(), 'function' == typeof n && n();
      };
    function v(e) {
      return (
        (function(e) {
    ...
    var m = function() {
        ...
        return function(t) {
          ...
          if (
            ...
            return;
          var o = t.key.match(/Control|Shift|Alt/)
              ? t.key
              : ''
                  .concat(t.ctrlKey ? 'control+' : '')
                  .concat(t.shiftKey ? 'shift+' : '')
                  .concat(t.altKey ? 'alt+' : '')
                  .concat(t.key.toLowerCase()),
            a = e[o];
          return (
            'function' == typeof a &&
              (t.preventDefault(),
      ...
      y = function() {
        ...
        return function(n) {
          ...
          var d = ''
            ...
            .concat(o > 1 ? '+d' + o : '')
            .concat(g ? '+rbm' : '');
          'click' == l && (d = ''.concat(c).concat(l)),
            'dblclick' == l && (d = ''.concat(c).concat(l));
          var s = n.deltaY;
          if (
            (s &&
              (d = ''
                ...
                .concat(r || '')),
            'mousedown' === l && 2 === t && (g = !0),
            !p.includes('wheel') || !d.includes('mouseup'))
          ) {
            var f = Math.floor((a / u.offsetWidth) * 10),
              v = Math.floor((i / u.offsetHeight) * 10);
            return (
      ...
      h = function(e, n) {
        ...
        return (
          ...
          new Promise(function(e) {
            t.onload = function() {
              e(n(t.contentDocument)), t.remove();
            };
          })
        );
      },
      b = function(e) {
        ...
        var n = l(void 0, { id: 'iyMediaContainer' });
        e.forEach(function(e) {
          l(
            {
              tag: 'a',
              parent: n,
              child: c('img', { src: e, className: 'iyMedia' })
            },
      ...
      w = function(e, n) {
        var t = e.video,
          r = n.modal,
          o = n.closeModalMouseKey,
          a = {
            click: function() {},
            mousedown1: function() {
              return s(t, n.videoshotOpt);
            },
            mouseup2: e.toggleControls,
            'wheeldown+g0208': function() {
              return e.decreasePlaybackRate(0.1);
            },
            'wheelup+g0208': function() {
              return e.increasePlaybackRate(0.1);
            },
            'mousedown0+g0228': function() {
              return e.normalizePlaybackRate();
            },
            ...
            'click+g3600': function() {
              return document.fullscreenElement
                ...
                : t.parentElement.webkitRequestFullscreen();
            },
        ...
        r && ((a['click+g7901'] = r.closeModal), (a[o] = r.closeModal));
        var i = !0 === n.mouseActionMap ? a : n.mouseActionMap;
        if (n.view) {
          var u = document.querySelector('#videoOverlay');
          u.addEventListener('click', y(i)),
            u.addEventListener('mousedown', y(i)),
            u.addEventListener('mouseup', y(i)),
            u.addEventListener('wheel', y(i)),
            u.addEventListener('contextmenu', f);
        } else
          t.addEventListener('click', y(i)),
            t.addEventListener('mousedown', y(i)),
            t.addEventListener('mouseup', y(i)),
            t.addEventListener('wheel', y(i));
      };
    var k = function(e) {
      var n,
        ...
        d = t.volumeBarLevel;
      function s() {
        clearInterval(n), l.classList.remove('waiting');
      }
      r.addEventListener('loadstart', function(e) {
        var n = Math.ceil(100 * r.volume);
        u.style.setProperty('--volumeBarState', ''.concat(n, '%')), B(n, d);
      }),
        r.addEventListener('timeupdate', function(e) {
          var n = Math.ceil(100 * r.volume);
          u.style.setProperty('--volumeBarState', ''.concat(n, '%')),
            B(n, d),
            l.style.setProperty(
              '--seekBarState',
            ...
            r.muted && u.style.setProperty('--volumeBarColor', '211, 47, 47');
          var t, s, f, v, m;
          r.muted || u.style.setProperty('--volumeBarColor', '25, 118, 210');
        }),
    ...
    var x = function(e, n) {
        var t = e.video,
          r = n.modal,
          o = n.startInFullScreen,
          a = n.startWithControlBar;
        l(
          { tag: 'style', parent: document.head },
          {
        ...
        var i = l(
          { parent: r ? r.modal : null, child: t, type: 'prepend' },
          { className: 'videoContainer', id: 'iyVideoControllerRoot' }
        );
        t.parentElement.webkitRequestFullscreen &&
          o &&
          t.parentElement.webkitRequestFullscreen();
        l({ parent: i }, { id: 'videoOverlay' });
        var u = l({ parent: i }, { className: 'controlsContainer' });
        !a && u.classList.add('hideControls');
        var c = l(
            { parent: u },
            { id: 'seekBarTime', innerText: '00:00 / 00:00' }
          ),
          d = l({ parent: u }, { id: 'seekBar', className: 'controlBars' }),
          s = l({ parent: u }, { id: 'volumeBar', className: 'controlBars' }),
          f = l({ parent: s }, { id: 'volumeBarLevel' });
        s.addEventListener('mousedown', function(n) {
          var r = n.offsetX / n.target.offsetWidth;
          e.muteOff(), (t.volume = r);
        }),
          s.addEventListener('wheel', function(n) {
            n.preventDefault(),
              e.muteOff(),
              n.deltaY < 0 ? e.volumeUp(0.02) : e.volumeDown(0.02);
          }),
          s.addEventListener('mousedown', m),
          s.addEventListener('mouseup', p),
          s.addEventListener('mouseout', g),
          s.addEventListener('mousemove', function(n) {
            if (!v) return;
            n.preventDefault();
            var r = Math.ceil((n.offsetX / n.target.offsetWidth) * 100) / 100;
            e.muteOff(), (t.volume = r);
          }),
          d.addEventListener('mousedown', function(e) {
            e.stopPropagation();
            var n = e.offsetX / this.offsetWidth;
            (t.currentTime = t.duration * n),
              d.style.setProperty('--seekBarState', ''.concat(100 * n, '%'));
          }),
          d.addEventListener('wheel', function(n) {
            n.stopPropagation(),
              n.preventDefault(),
              n.deltaY < 0 ? e.seekForward(1) : e.seekBackward(1);
          }),
          d.addEventListener('mousedown', m),
          d.addEventListener('mouseup', p),
          d.addEventListener('mouseout', g),
        ...
        k(e, { seekBar: d, volumeBar: s, seekBarTime: c, volumeBarLevel: f });
      },
      C = function(e) {
        var n = e.video,
          t = e.videoIndex,
        ...
        r.forEach(function(e) {
          ...
          o.insertBefore(n, o.children[t]);
      },
      O = function(e, n) {
        var t = n.videoIndex,
          r = n.originalVideoAttributes,
          o = n.originalVideoParent,
          a = l({}, { id: 'iyModal' });
        return (
          l(
            { tag: 'style', parent: document.head },
      ...
      return {
        getBufferState: function() {
          for (
            ...
            o.push({ start: n.start(a), end: n.end(a) });
          return {
        ...
        increasePlaybackRate: function() {
          var t =
            arguments.length > 0 && void 0 !== arguments[0]
              ? arguments[0]
              : n.playbackRateChange;
          return (e.playbackRate += t);
        },
          ...
          var n =
            ...
            r =
              arguments.length > 1 && void 0 !== arguments[1]
                ? arguments[1]
                : {};
          r = E({}, { currentBuffer: !1, customBufferTime: 1 }, r);
          var o = e.currentTime;
          (o -= n),
            r.currentBuffer
          ...
          var n =
            ...
            r =
              arguments.length > 1 && void 0 !== arguments[1]
                ? arguments[1]
                : {};
          r = E({}, { currentBuffer: !1, customBufferTime: 2 }, r);
          var o = e.currentTime,
            a = e.duration;
          (o += n),
            r.currentBuffer
        ...
        volumeDown: function() {
          var t =
              arguments.length > 0 && void 0 !== arguments[0]
                ...
                : n.volumeChange,
            r = e.volume;
          (r -= t), (e.volume = r > 0 ? r : 0), (e.muted = !1);
        },
        volumeUp: function() {
          var t =
              arguments.length > 0 && void 0 !== arguments[0]
                ...
                : n.volumeChange,
            r = e.volume;
          (r += t), (e.volume = r < 1 ? r : 1), (e.muted = !1);
        }
      };
    };
    function L(e) {
    ...
    var j = function(e) {
      ...
      'modal' === n.view &&
        ((n.originalVideoAttributes = t),
        (n.originalVideoParent = e.parentElement),
        (n.videoIndex = L(e.parentElement.children).findIndex(function(e) {
          ...
          (function(e, n) {
            var t = n.modal,
              r = {
                ' ': e.togglePlay,
                s: e.togglePlay,
                arrowright: e.seekForward,
                d: e.seekForward,
                arrowleft: e.seekBackward,
                a: e.seekBackward,
                arrowup: e.volumeUp,
                arrowdown: e.volumeDown,
                e: function() {
                  return e.increasePlaybackRate(0.1);
                },
            ...
            t && (r['alt+q'] = t.closeModal);
            var o = !0 === n.keyboardActionMap ? r : n.keyboardActionMap;
            document.addEventListener('keydown', m(o, ['BODY', 'VIDEO']));
          })(a, n),
        n.mouseActionMap && w(a, n),
        a
      );
    };
    t.d(n, 'cleanDocument', function() {
      return o;
    }),
      t.d(n, 'convertSecondsToTimeUnits', function() {
        return a;
      }),
      t.d(n, 'craddel', function() {
        return l;
      }),
      t.d(n, 'crel', function() {
        return c;
      }),
      t.d(n, 'formatTimeForVideo', function() {
        return i;
      }),
      t.d(n, 'getVideoshot', function() {
        return s;
      }),
      t.d(n, 'handleContextMenu', function() {
        return f;
      }),
      t.d(n, 'handleKeyboardEvent', function() {
        return m;
      }),
      t.d(n, 'handleMouseEvent', function() {
        return y;
      }),
      t.d(n, 'openInIframe', function() {
        return h;
      }),
      t.d(n, 'photoshowSimple', function() {
        return b;
      }),
      t.d(n, 'removeAttributes', function() {
        return r;
      }),
      t.d(n, 'createVideoController', function() {
        return j;
      });
  }
]);
